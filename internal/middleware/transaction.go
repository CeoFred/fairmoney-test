...
// func OnlyAdmin(db *gorm.DB, u *repository.AccountRepository) gin.HandlerFunc {
...
// 		_, found, err := repository.AccountRepository(db).FindByCondition("email", claims.Email)
